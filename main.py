...
for epoch in range(1):
    ...
    for i, item in enumerate(train_loader):
        ...
        for label0,output0 in zip(label,output):
            if spike_output[label0] == []:
                spike_output[label0] = [output0]
            else:
                spike_output[label0].append(output0)
        ...
        if((i+1)%1000==0):
            ...
            im=None
            # matplotlib.axes.Axes.imshow(im)
            # plt.pause(0.01)
